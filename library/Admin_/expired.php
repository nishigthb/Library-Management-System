...
<head>
	...
	<style type="text/css">
		...
		body {
        background-image: url("images/issue_book.jpg");
  ...
  <div class="container">
    ...
    <?php
      ...
      <form method="post" action="">
          <button name="submit2" type="submit" class="btn btn-default" style="background-color: #06861a; color: yellow;">RETURNED</button> <br>
                     <br>
          <button name="submit3" type="submit" class="btn btn-default" style="background-color: red; color:black;">EXPIRED</button> <br>
      </form>
      </div>
