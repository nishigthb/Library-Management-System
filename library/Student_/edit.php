...
<body style="background-color:#D3D3D3;">
	...
	<?php 
		...
		if(isset($_POST['submit'])) //save new  changes 
		{
			...
			$sql1= "UPDATE student SET pic='$pic', first='$first',middle='$middle', last='$last', username='$username', password='$password', email='$email' WHERE username='".$_SESSION['login_user']."';";
