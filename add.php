...
<head>
  ...
  background-image: url("bgadd.jpg");
...
<div id="mySidenav" class="sidenav">
 ...
 <div class="h"> <a href="listofbooks.php">Search Books</a> </div> 
  <div class="h"> <a href="deletebooks.php">Delete Books</a></div>
  <div class="h"> <a href="return.php">Book Request</a></div>
...
<center><h2 style="color:white;" >     ADD NEW BOOK </h2></center> <br><br>    <br><br>    
     <form class="book" action="" method="post">       
        ...
        <button style="text-align: center;width: 30%; height: 40%;" class="btn btn-default" type="submit" name="submit">ADD</button>
    </form> 
